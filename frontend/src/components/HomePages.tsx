...
export default function HomePages() {
  const sections = [
    {
      title: 'Учебное',
      description: 'Файлы, ресурсы и сведения в рамках программ подготовок.',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {sections.map((section, idx) => (
          <Link
            key={idx}
            href={section.href}
            className="section-card block bg-white rounded-xl shadow-md overflow-hidden animate-fade-in-up"
