...
\begin{itemize}
    ...
    \item Фиксированный
\end{itemize}
\includegraphics[scale=0.2]{lecture08_01.jpg}
...
\subsection{Определение | Колленирные векторы}
\[
...
\begin{align*}
    ...
    \end{sqcases}
\end{align*}
\includegraphics[scale=0.3]{lecture08_02.jpg}


\subsection{Определение | Компланарные векторы}
Компланарными векторами называются 3 и более векторов в пространстве, которые параллельны плоскости:
\[
    (\overline{a}, \overline{b}, \overline{c}, \dots) \parallel P
\]
\includegraphics[scale=0.15]{lecture08_03.jpg}
...
\includegraphics[scale=0.15]{lecture08_04.jpg}

\subsubsection{Если некомпланарны}
\includegraphics[scale=0.2]{lecture08_05.jpg}
...
\end{itemize}
\includegraphics[scale=0.2]{lecture08_06.jpg}
...
\begin{gather*}
    ...
    \end{cases}
\end{gather*}
\includegraphics[scale=0.3]{lecture08_07.jpg}
...
\par\noindent\rule{\textwidth}{1pt}
\section{Свойства колленирных векторов}
...
\includegraphics[scale=0.2]{lecture08_08.jpg}
...
\end{gather*}
\includegraphics[scale=0.3]{lecture10_01.png}
...
\begin{gather*}
    ...
    \end{cases} \Rightarrow
\end{gather*}
\includegraphics[scale=0.3]{lecture10_02.png}
...
\begin{gather*}
    ...
    \end{cases}
\end{gather*}
\includegraphics[scale=0.3]{lecture10_03.png}
...
\begin{gather*}
    ...
    Ax + By + Cz + D = 0
\end{gather*}
\includegraphics[scale=0.3]{lecture10_04.png}



\section{Уравнение плоскости в отрезках}
\includegraphics[scale=0.3]{lecture10_05.png}
\begin{gather*}
...
\[
    Ax + By + Cz + D = 0
\]
\includegraphics[scale=0.3]{lecture10_06.png}
\paragraph{Дано}
\begin{gather*}
    \begin{cases}
        M_1(x_1, y_1, z_1) \\
...
\end{gather*}
\includegraphics[scale=0.3]{lecture10_07.png}
...
\end{gather*}
\includegraphics[scale=0.3]{lecture10_08.png}
...
\includegraphics[scale=0.3]{lecture10_09.png}
\begin{gather*}
    L = P_1 \cap P_2 \\
...
\includegraphics[scale=0.3]{lecture10_10.png}
\begin{gather*}
...
\includegraphics[scale=0.3]{lecture11_01.png}
\begin{gather*}
...
\includegraphics[scale=0.2]{lecture11_02.png}
\begin{align*}
    \begin{rcases}
...
\subsection{Пример}
\includegraphics[scale=0.3]{lecture11_03.png}
\begin{gather*}
...
\includegraphics[scale=0.3]{lecture11_04.png}
\begin{align*}
    \begin{rcases}
...
\end{gather*}
\includegraphics[scale=0.3]{lecture11_05.png}


\section{Расстояние от точки до прямой линии $L$}
\includegraphics[scale=0.3]{lecture11_06.png}
\begin{gather*}
    L: \frac{x - x_0}{m} = \frac{y- y_0}{n} = \frac{z - z_0}{p} \\
...
\end{gather*}
\includegraphics[scale=0.3]{lecture11_07.png}
...
\]
\includegraphics[scale=0.3]{lecture11_08.png}
...
~\\
\includegraphics[scale=0.3]{lecture11_09.png}
\begin{gather*}
...
\]
\includegraphics[scale=0.3]{lecture11_10.png}
...
\]
\includegraphics[scale=0.3]{lecture11_11.png}

\subsubsection{Характеристики}
\paragraph{Расстояние $\rho(L_1 \nparallel L_2)$}
~\\
\includegraphics[scale=0.3]{lecture11_12.png}
...
\includegraphics[scale=0.3]{lecture11_13.png}
\begin{gather*}
...
\subsection{Пример}
\includegraphics[scale=0.3]{lecture11_14.png}
\begin{align*}
...
\subsection{Пример}
\includegraphics[scale=0.3]{lecture11_15.png}
\begin{align*}
