...
— **Хорошо, я готов помочь. Что дальше?** <br>
— Достаточно написать об этом [владельцу проекта](https://t.me/iannsgirdye). Взамен ты будешь добавлен на соответствующую доску почёта (в `/project/people`).
